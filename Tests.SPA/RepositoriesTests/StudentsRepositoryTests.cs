...
//                 Description = "A", Age = 1, Education = null, Lessons = new List<LessonEntity>(),
//                 Reviews = new List<ReviewEntity>(), Contacts = new List<StudentContactEntity>()
//             },
//             new()
//             {
//                 Id = new Guid("40503af9-7569-4015-879e-6f70d0088de1"), FirstName = "B", LastName = "B",
//                 Description = "B", Age = 2, Education = null, Lessons = new List<LessonEntity>(),
//                 Reviews = new List<ReviewEntity>(), Contacts = new List<StudentContactEntity>()
//             },
//             new()
//             {
//                 Id = new Guid("3c7ffa34-a234-43dc-ab20-849b211190c2"), FirstName = "C", LastName = "C",
//                 Description = "C", Age = 3, Education = null, Lessons = new List<LessonEntity>(),
//                 Reviews = new List<ReviewEntity>(), Contacts = new List<StudentContactEntity>()
//             }
//         };
//
...
//             Assert.That(entity, Is.InstanceOf<Student>());
//         });
//     }
//
//     [Test]
