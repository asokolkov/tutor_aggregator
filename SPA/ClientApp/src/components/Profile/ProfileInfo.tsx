import {Avatar, Container, Text, WrapItem, HStack, VStack} from "@chakra-ui/react";
    ...
    return (
            <Container maxW="90%" bg={'white'}>
                <HStack padding={'8px'}>
                    ...
                    <VStack align={'left'}>
                        <Text as='b' fontSize='2xl'>{props.name}</Text>
                ...
                <VStack align={'left'} padding={'8px'}>
                    ...
                    <HStack>
                        ...
                        <Text fontSize='m'>{props.rating.average} на основе {props.rating.count} отзывов</Text>
                    </HStack>
                </VStack>
