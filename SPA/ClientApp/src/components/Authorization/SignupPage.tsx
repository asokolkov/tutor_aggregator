...
export const SignupPage = () => {
    ...
    const handleSubmit = () => {
        ...
        const accountType = accountTypeRef.current.checked ? AccountType.Tutor : AccountType.Student;
                ...
                <VStack margin={'20px'} width={'100%'}>
                    ...
                    >
                        ...
                        <FormControl>
                            ...
                            <HStack>
                                <Input ref={firstNameRef} id="name" type="text" placeholder="Введите имя"/>
                                <Input
                                    ref={lastNameRef}
                                    id="surname"
                                    type="text"
                        ...
                        <FormControl>
                            ...
                            <HStack>
                                <InputGroup>
                                    ...
                                    <Input ref={phoneRef} id="tel" type="tel" placeholder="9991234567"/>
                                </InputGroup>
                            </HStack>
                        </FormControl>
                        <FormControl>
